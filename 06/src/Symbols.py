class Symbols():
    ...
    #Agregar una pareja a la tabla de símbolos.
    def add_entry(self, symbol, address):
        self.symbolTable[symbol] = address
    
    #Verificar si la tabla de símbolos contiene el símbolo pedido.
    def contains(self, symbol):
        return symbol in self.symbolTable

    #Obtener la dirección de memoria en la que está contenido el símbolo.
